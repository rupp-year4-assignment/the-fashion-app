...
function buildDeepLink(req: Request, status: "success" | "cancel") {
...
route.get("/payment/success", (req: Request, res: Response) => {
  res.setHeader("Content-Type", "text/html; charset=utf-8");
  res.status(200).send(
    buildReturnPage({
      title: "Payment Confirmed",
      subtitle:
        "Your payment was received. Returning you to The Fashion App so the order status can refresh.",
      accentColor: "#15803d",
...
route.get("/payment/cancel", (req: Request, res: Response) => {
  res.setHeader("Content-Type", "text/html; charset=utf-8");
  res.status(200).send(
    buildReturnPage({
      title: "Payment Cancelled",
      subtitle:
        "No charge was completed. Return to the app to try payment again or choose a different method.",
      accentColor: "#b45309",
